...
@Database(entities = [Product::class, Role::class, Cart::class, Category::class, UserProfile::class, PaymentMethod::class, Wishlist::class], version = 1, exportSchema = false)
